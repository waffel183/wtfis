...
from wtfis.models.virustotal import Domain, HistoricalWhois, Resolutions, Ip
...
class VTClient(BaseClient):
    ...
    def get_ip_report(self, ip: str) -> Ip:
        return Ip.parse_obj(self._get(f"/ip_addresses/{ip}"))
